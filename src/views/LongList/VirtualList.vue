...
export default {
  ...
  props: {
	...
	computed: {
      ...
      console.log('%c 🍤 展示的项数之前多渲染几项: ', 'font-size:20px;background-color: #33A5FF;color:#fff;', prevCount);
	...
	updated() {
    console.log('%c 🍆 updated: ', 'font-size:20px;background-color: #33A5FF;color:#fff;');
		this.$nextTick(() => {
			// 确保 dom 已经更新
